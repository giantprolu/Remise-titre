...
INSERT INTO responses (id, name, question1, question3, photo, "createdAt", isAnonymous) VALUES
...
(gen_random_uuid()::text, 'Emma Dupont',
 ...
 NULL, NOW() - INTERVAL '2 hours', true),
...
(gen_random_uuid()::text, 'Lucas Martin',
 ...
 NULL, NOW() - INTERVAL '1 hour 50 minutes', true),
...
(gen_random_uuid()::text, 'Chloé Bernard',
 ...
 NULL, NOW() - INTERVAL '1 hour 40 minutes', false),
...
(gen_random_uuid()::text, 'Noah Thomas',
 ...
 NULL, NOW() - INTERVAL '1 hour 30 minutes', false),
...
(gen_random_uuid()::text, 'Léa Petit',
 ...
 NULL, NOW() - INTERVAL '1 hour 20 minutes', false),
...
(gen_random_uuid()::text, 'Hugo Leroy',
 ...
 NULL, NOW() - INTERVAL '1 hour 10 minutes', false),
...
(gen_random_uuid()::text, 'Gabriel Dubois',
 ...
 NULL, NOW() - INTERVAL '55 minutes', false),
...
(gen_random_uuid()::text, 'Camille Laurent',
 ...
 NULL, NOW() - INTERVAL '50 minutes', false),
...
(gen_random_uuid()::text, 'Théo Simon',
 ...
 NULL, NOW() - INTERVAL '45 minutes', false),
...
(gen_random_uuid()::text, 'Inès Fontaine',
 ...
 NULL, NOW() - INTERVAL '40 minutes', false),
...
(gen_random_uuid()::text, 'Maxime Rousseau',
 ...
 NULL, NOW() - INTERVAL '35 minutes', false),
...
(gen_random_uuid()::text, 'Jade Mercier',
 ...
 NULL, NOW() - INTERVAL '30 minutes', false),
...
(gen_random_uuid()::text, 'Antoine Girard',
 ...
 NULL, NOW() - INTERVAL '25 minutes', false),
...
(gen_random_uuid()::text, 'Zoé Bonnet',
 ...
 NULL, NOW() - INTERVAL '22 minutes', false),
...
(gen_random_uuid()::text, 'Ethan Lefebvre',
 ...
 NULL, NOW() - INTERVAL '18 minutes', false),
...
(gen_random_uuid()::text, 'Clara Dumont',
 ...
 NULL, NOW() - INTERVAL '15 minutes', false),
...
(gen_random_uuid()::text, 'Louis Garnier',
 ...
 NULL, NOW() - INTERVAL '12 minutes', false),
...
(gen_random_uuid()::text, 'Anaïs Morel',
 ...
 NULL, NOW() - INTERVAL '8 minutes', false),
...
(gen_random_uuid()::text, 'Raphaël Perrin',
 ...
 NULL, NOW() - INTERVAL '3 minutes', false);
